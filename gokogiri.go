...
import (
	"github.com/monetha/gokogiri/html"
	"github.com/monetha/gokogiri/xml"
)
...
found in the github.com/monetha/gokogiri/xml package. The xml.StrictParsingOption is conveniently provided for standards-compliant
behaviour.
*/
